...
%>
<hr>
<form id="listc_form" method="post">
<table id="listc_table" align=center>
  <tr class="header">
    <th class="item1" rowspan="2">책가방</th>
...
%>
  <tr >
     <td><a href="insertbag_action.html?CNum=<%=rset.getString("CNum")%>" onclick="window.open(this.href, '_blank', 'width=300, heigh=200); return false"><button>추가</button></a></td>
